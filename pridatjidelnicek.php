...
if (!empty($_POST)) { #pridani vlastniho jidla
    ...
    if (empty($errors)) {#pridani
        $queryPridat= $db->prepare('INSERT INTO jidelnicek (nazev, popis, cukry, sacharidy, bilkoviny) VALUE (:nazev, :popis, :cukry, :sacharidy, :bilkoviny)');
